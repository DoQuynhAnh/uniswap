...
export const PoolOptionItemContextMenu = memo(function _PoolOptionItemContextMenu({ children, poolInfo, }) {
    ...
    return (_jsx(ContextMenu, { menuItems: dropdownOptions, triggerMode: ContextMenuTriggerMode.Secondary, isOpen: isOpen, closeMenu: closeContextMenu, openMenu: openContextMenu, children: children }));
});
//# sourceMappingURL=PoolOptionItemContextMenu.web.js.map