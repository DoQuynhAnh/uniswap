...
export declare function OnchainItemList<T extends OnchainItemListOption>(_props: OnchainItemListProps<T>): JSX.Element;
//# sourceMappingURL=OnchainItemList.d.ts.map