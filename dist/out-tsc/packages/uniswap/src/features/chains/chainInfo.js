...
import { ARBITRUM_LOGO, AVALANCHE_LOGO, BASE_LOGO, BLAST_LOGO, BNB_LOGO, CELO_LOGO, ETHEREUM_LOGO, ETH_LOGO, MONAD_LOGO, OPTIMISM_LOGO, POLYGON_LOGO, SONEIUM_LOGO, UNICHAIN_LOGO, UNICHAIN_SEPOLIA_LOGO, WORLD_CHAIN_LOGO, ZKSYNC_LOGO, ZORA_LOGO, } from 'ui/src/assets';
import { config } from 'uniswap/src/config';
import { CUSD_CELO, DAI, DAI_ARBITRUM_ONE, DAI_OPTIMISM, DAI_POLYGON, USDB_BLAST, USDC, USDC_ARBITRUM, USDC_AVALANCHE, USDC_BASE, USDC_BNB, USDC_CELO, USDC_OPTIMISM, USDC_POLYGON, USDC_SEPOLIA, USDC_SONEIUM, USDC_UNICHAIN, USDC_UNICHAIN_SEPOLIA, USDC_WORLD_CHAIN, USDC_ZKSYNC, USDC_ZORA, USDT, USDT_MONAD_TESTNET, } from 'uniswap/src/constants/tokens';
...
import { arbitrum, avalanche, base, blast, bsc, celo, mainnet, optimism, polygon, sepolia, soneium, unichainSepolia, zkSync, zora, } from 'wagmi/chains';
...
export function getQuicknodeChainId(chainId) {
    switch (chainId) {
...
export function getQuicknodeChainIdPathSuffix(chainId) {
    switch (chainId) {
        case UniverseChainId.Avalanche:
...
export function getQuicknodeEndpointUrl(chainId) {
...
function getPlaywrightRpcUrls(url) {
    return {
...
export const UNIVERSE_CHAIN_INFO = {
    ...
    [UniverseChainId.Soneium]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_SONEIUM, 10000000000),
    ...
    [UniverseChainId.Unichain]: {
        ...
        spotPriceStablecoinAmount: CurrencyAmount.fromRawAmount(USDC_UNICHAIN, 10000000000),
