...
import { useCurrentAccountChainMismatchEffect, useOnConnectCheckAllAccountChainMismatchEffect, } from 'uniswap/src/features/smartWallet/mismatch/hooks';
 ...
 * @returns null
 */
const MismatchAccountEffectsInner = React.memo(() => {
...
export const MismatchAccountEffects = () => {
    ...
    return _jsx(MismatchAccountEffectsInner, {});
};
//# sourceMappingURL=MismatchAccountEffects.js.map