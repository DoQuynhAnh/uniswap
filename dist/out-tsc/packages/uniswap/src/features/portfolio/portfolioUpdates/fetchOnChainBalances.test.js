...
const mockGetOnChainBalancesFetch = getOnChainBalancesFetch;
...
describe(fetchOnChainBalances, () => {
    ...
    it('fetches on-chain balances for valid currency IDs', async () => {
        ...
        mockApolloCache.readQuery.mockReturnValueOnce({
            token: mockToken,
        });
        ...
        expect(onchainBalance === null || onchainBalance === void 0 ? void 0 : onchainBalance.rawBalance).toBe(mockBalance);
        expect(onchainBalance === null || onchainBalance === void 0 ? void 0 : onchainBalance.quantity).toBe(1);
    });
    it('handles native currency correctly', async () => {
        ...
        expect(balanceInfo === null || balanceInfo === void 0 ? void 0 : balanceInfo.rawBalance).toBe(mockBalance);
        expect(balanceInfo === null || balanceInfo === void 0 ? void 0 : balanceInfo.quantity).toBe(2);
    });
    ...
    it('processes multiple currency IDs in parallel', async () => {
        ...
        mockApolloCache.readQuery.mockReturnValueOnce({ token: mockToken }).mockReturnValueOnce({
...
//# sourceMappingURL=fetchOnChainBalances.test.js.map