export declare enum DappRequestType {
...
export declare enum DappResponseType {
...
export type ExtensionEthMethod = EthMethod.EthChainId | EthMethod.EthRequestAccounts | EthMethod.EthAccounts | EthMethod.EthSendTransaction | EthMethod.PersonalSign | EthMethod.WalletSwitchEthereumChain | EthMethod.WalletGetPermissions | EthMethod.WalletRequestPermissions | EthMethod.WalletRevokePermissions | EthMethod.WalletGetCapabilities | EthMethod.WalletSendCalls | EthMethod.WalletGetCallsStatus | EthMethod.SignTypedDataV4;
export type WalletConnectEthMethod = EthMethod.EthSign | EthMethod.EthSendTransaction | EthMethod.SignTypedData | EthMethod.SignTypedDataV4 | EthMethod.WalletSwitchEthereumChain | EthMethod.WalletGetCapabilities | EthMethod.WalletSendCalls | EthMethod.WalletGetCallsStatus | EthMethod.WalletAddEthereumChain | EthMethod.PersonalSign;
export type EthSignMethod = EthMethod.PersonalSign | EthMethod.SignTypedData | EthMethod.SignTypedDataV4 | EthMethod.EthSign;
