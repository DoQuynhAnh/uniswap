 ...
 */
export function useLocalizedStatsigLanguage() {
    var _a, _b;
    const { i18n } = useTranslation();
    const parsedLocale = parseLocale(i18n.resolvedLanguage);
    const resources = i18n.services.backendConnector.options.resources;
    if (typeof parsedLocale !== 'string' || !(parsedLocale in resources)) {
        return null;
    }
    return (_b = (_a = resources[parsedLocale]) === null || _a === void 0 ? void 0 : _a.statsigKey) !== null && _b !== void 0 ? _b : null;
}
// Locale
/**
