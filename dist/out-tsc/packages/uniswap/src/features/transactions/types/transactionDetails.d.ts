...
export declare const TEMPORARY_TRANSACTION_STATUSES: TransactionStatus[];
...
export type TransactionTypeInfo = ApproveTransactionInfo | Permit2ApproveTransactionInfo | BridgeTransactionInfo | ExactOutputSwapTransactionInfo | ExactInputSwapTransactionInfo | ConfirmedSwapTransactionInfo | WrapTransactionInfo | SendTokenTransactionInfo | ReceiveTokenTransactionInfo | NFTTradeTransactionInfo | NFTApproveTransactionInfo | NFTMintTransactionInfo | WCConfirmInfo | UnknownTransactionInfo | OnRampPurchaseInfo | OnRampTransferInfo | OffRampSaleInfo | LocalOnRampTransactionInfo | LocalOffRampTransactionInfo | SendCallsTransactionInfo;
