...
const useSwapFormContextMock = useSwapFormContext;
describe('useSyncFiatAndTokenAmountUpdater', () => {
    ...
    const mockCurrencyAmount = { toExact: jest.fn().mockReturnValue('1') };
    beforeEach(() => {
        jest.clearAllMocks();
        // Setup mocks
...
//# sourceMappingURL=useSyncFiatAndTokenAmountUpdater.test.js.map