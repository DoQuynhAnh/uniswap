...
describe('useSwapNetworkChangeEffect', () => {
    ...
    it('does not call onSwapChainsChanged if input and output chain ids are the same', () => {
        const { rerender } = renderHook(({ inputChainId, outputChainId }) => useSwapNetworkChangeEffect({ inputChainId, outputChainId }), {
            initialProps: {
...
//# sourceMappingURL=useSwapNetworkChangeEffect.test.js.map