...
export const useOnToggleIsFiatMode = ({ formattedDerivedValueRef, moveCursorToEnd, }) => {
    const { exactAmountFiatRef, exactAmountTokenRef, exactCurrencyField, focusOnCurrencyField, isFiatMode, updateSwapForm, } = useSwapFormContext();
    return useEvent((currencyField) => {
...
//# sourceMappingURL=useOnToggleIsFiatMode.js.map