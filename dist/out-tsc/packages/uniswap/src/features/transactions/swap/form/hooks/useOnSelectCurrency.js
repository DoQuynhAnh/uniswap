...
export function useOnSelectCurrency({ onSelect, }) {
    ...
    ({ currency, field, forceIsBridgePair, isPreselectedAsset, }) => {
        ...
        if (otherFieldTradeableAsset && areCurrencyIdsEqual(currencyId(currency), currencyId(otherFieldTradeableAsset))) {
            ...
            const otherCurrencyInNewChain = (_a = otherFieldTokenProjects === null || otherFieldTokenProjects === void 0 ? void 0 : otherFieldTokenProjects.data) === null || _a === void 0 ? void 0 : _a.find((project) => (project === null || project === void 0 ? void 0 : project.currency.chainId) === currency.chainId);
            // if new token chain changes, try to find the other token's match on the new chain
            const otherTradeableAssetInNewChain = otherCurrencyInNewChain && {
        ...
        const todoFixMeOtherCurrency = (_b = otherFieldTokenProjects === null || otherFieldTokenProjects === void 0 ? void 0 : otherFieldTokenProjects.data) === null || _b === void 0 ? void 0 : _b.find((project) => (project === null || project === void 0 ? void 0 : project.currency.chainId) === currency.chainId);
        const currencyState = {
            inputCurrency: CurrencyField.INPUT === field ? currency : todoFixMeOtherCurrency === null || todoFixMeOtherCurrency === void 0 ? void 0 : todoFixMeOtherCurrency.currency,
            outputCurrency: CurrencyField.OUTPUT === field ? currency : todoFixMeOtherCurrency === null || todoFixMeOtherCurrency === void 0 ? void 0 : todoFixMeOtherCurrency.currency,
        };
        onSelect === null || onSelect === void 0 ? void 0 : onSelect();
        updateSwapForm(newState);
        maybeLogFirstSwapAction(traceRef.current);
        onCurrencyChange === null || onCurrencyChange === void 0 ? void 0 : onCurrencyChange(currencyState, isBridgePair);
    }, 
 ...
 */
function checkIsBridgePair({ queryClient, input, output, }) {
    ...
    const inputHasMatchingBridgeToken = !!inputBridgePairs &&
        hasMatchingBridgeToken({
            bridgePairs: inputBridgePairs,
            tokenAddress: tokenOut,
            tokenChainId: tokenOutChainId,
        });
    const outputHasMatchingBridgeToken = !!outputBridgePairs &&
        hasMatchingBridgeToken({
...
function hasMatchingBridgeToken({ bridgePairs, tokenAddress, tokenChainId, }) {
    return !!bridgePairs.tokens.find((token) => areAddressesEqual(token.address, tokenAddress) && token.chainId === tokenChainId);
}
//# sourceMappingURL=useOnSelectCurrency.js.map