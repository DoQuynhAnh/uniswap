...
describe('useChainIdsChangeEffect', () => {
    describe.each([
        ...
        it(`should ${skip ? 'not ' : ''}trigger callback on first render`, () => {
            ...
            renderHook(() => useChainIdsChangeEffect({
    ...
    test.each([
        {
            ...
            chainStates: [
                { inputChainId: UniverseChainId.Mainnet, outputChainId: UniverseChainId.Optimism },
                { inputChainId: undefined, outputChainId: UniverseChainId.Optimism },
            ],
            expectedChanges: { input: true, output: false },
        },
        {
            ...
            chainStates: [
                { inputChainId: UniverseChainId.Mainnet, outputChainId: UniverseChainId.Optimism },
                { inputChainId: UniverseChainId.Mainnet, outputChainId: undefined },
            ],
            expectedChanges: { input: false, output: true },
        },
    ...
    it('should handle when callback is not provided', () => {
        ...
        const { rerender } = renderHook(() => useChainIdsChangeEffect({
            inputChainId,
            outputChainId,
        }));
        // Update state variables and rerender
...
//# sourceMappingURL=useChainIdsChangeEffect.test.js.map