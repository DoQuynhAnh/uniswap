...
export function useTrade({ account, amountSpecified: amount, otherCurrency, tradeType, pollInterval, customSlippageTolerance, isUSDQuote, skip, selectedProtocols, isDebouncing, generatePermitAsTransaction, isV4HookPoolsEnabled, }) {
    ...
    const isZeroAmount = (amount === null || amount === void 0 ? void 0 : amount.quotient.toString()) === '0';
    ...
    const [lastReqStart, setLastReqStart] = useState();
    useEffect(() => {
