...
export function getSwapFee(quoteResponse) {
    const quote = quoteResponse === null || quoteResponse === void 0 ? void 0 : quoteResponse.quote;
    if (!quote) {
        return undefined;
    }
    ...
    if (!(ulFee === null || ulFee === void 0 ? void 0 : ulFee.bps) || !(ulFee === null || ulFee === void 0 ? void 0 : ulFee.amount)) {
        return undefined;
    }
    return {
...
//# sourceMappingURL=getSwapFee.js.map