...
import { TokenProtectionWarning, getFeeColor, getFeeWarning, getShouldHaveCombinedPluralTreatment, getTokenProtectionWarning, getTokenWarningSeverity, useCardHeaderText, useCardSubtitleText, useModalHeaderText, useModalSubtitleText, useTokenWarningCardText, } from 'uniswap/src/features/tokens/safetyUtils';
...
describe('useTokenWarningCardText', () => {
    ...
    it('returns correct text for spam airdrop warning', () => {
        expect(useTokenWarningCardText({
            ...mockCurrencyInfo,
