...
export type { Adapt, AnchorProps, CircleProps, ColorTokens, GetProps, GetRef, GetThemeValueForKey, ImageProps, InputProps, PopperProps, SpaceTokens, TabLayout, TabsTabProps, TamaguiElement, TamaguiProviderProps, TextStyle, ThemeKeys, ThemeName, Tokens, ViewProps, } from 'tamagui';
