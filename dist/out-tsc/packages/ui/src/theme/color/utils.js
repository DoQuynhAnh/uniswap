 ...
 * @returns
 */
export function opacify(opacity, color) {
    return opacifyRaw(opacity, color);
}
/**
 ...
 * @returns
 */
export function opacifyRaw(opacity, color) {
    'worklet';
    try {
...
function _opacifyRgba(opacity, color) {
    ...
    const parts = (_a = match[1]) === null || _a === void 0 ? void 0 : _a.split(',').map((p) => p.trim());
