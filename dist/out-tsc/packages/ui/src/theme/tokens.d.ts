...
export declare const getIsTokenFormat: (value: string) => boolean;
export declare const getIsValidSporeColor: (value: string) => boolean;
export declare const validateColorValue: (value: ColorValue) => {
    isValid: boolean;
    error?: Error;
};
export declare const validColor: (value: ColorValue) => ColorTokens;
/**
 ...
 */
export declare const getMaybeHoverColor: (nonHoveredColor: ColorValue) => ColorTokens;
export {};
