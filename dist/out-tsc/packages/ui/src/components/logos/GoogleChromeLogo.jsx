...
export const [GoogleChromeLogo, AnimatedGoogleChromeLogo] = createIcon({
    ...
    getIcon: (props) => (<Svg viewBox="0 0 48 48" {...props}>
      <Defs>
      ...
      <_Circle cx="24" cy="23.9947" r="12" fill={'currentColor' !== null && 'currentColor' !== void 0 ? 'currentColor' : '#fff'}/>
...
//# sourceMappingURL=GoogleChromeLogo.jsx.map