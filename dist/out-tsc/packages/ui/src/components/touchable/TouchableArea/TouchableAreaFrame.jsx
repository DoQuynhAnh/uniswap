...
export const TouchableAreaFrame = styled(YStack, {
    ...
    variants: {
        ...
        variant: {
            ...
            raised: (_, { props: { hoverable, disabled } }) => {
                return {
...
//# sourceMappingURL=TouchableAreaFrame.jsx.map