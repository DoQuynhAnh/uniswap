 ...
 *
 */
export const getHitSlop = ({ width, height }) => {
 ...
 * ```
 */
export const useAutoHitSlop = (onLayoutArg) => {
    const [frameSize, setFrameSize] = useState(undefined);
    const onLayout = useCallback((event) => {
        onLayoutArg === null || onLayoutArg === void 0 ? void 0 : onLayoutArg(event);
    ...
    return [finalHitSlop, onLayout];
};
//# sourceMappingURL=useAutoHitSlop.js.map