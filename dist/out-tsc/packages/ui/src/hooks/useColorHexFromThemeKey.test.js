...
const mockUseSporeColors = useSporeColors;
describe(useColorHexFromThemeKey, () => {
    ...
    it('returns the correct color object from theme', () => {
        ...
        const mockColors = {
            neutral1: { val: '#000000', get: () => '#000000', variable: 'neutral1' },
            accent1: { val: '#FC72FF', get: () => '#FC72FF', variable: 'accent1' },
            surface1: { val: '#FFFFFF', get: () => '#FFFFFF', variable: 'surface1' },
        };
    ...
    it('handles empty color object', () => {
        mockUseSporeColors.mockReturnValue({});
        const { result } = renderHook(() => useColorHexFromThemeKey('neutral1'));
        expect(result.current).toBeUndefined();
    });
});
//# sourceMappingURL=useColorHexFromThemeKey.test.js.map